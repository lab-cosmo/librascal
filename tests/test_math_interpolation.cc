...
#include "test_math_interpolation.hh"
...
namespace rascal {
  ...
  BOOST_FIXTURE_TEST_CASE_TEMPLATE(functions_interpolator_tests, Fix,
    ...
    for (const auto pair : Fix::functions) {
      ...
      if (verbose) { std::cout << "Interpolator interpolator fineness: " << Fix::intp.grid_fineness << std::endl;}
  ...
  BOOST_FIXTURE_TEST_CASE(functions_interpolator_vectorized_test,
    ...
    for (const auto pair : functions) {
      ...
      if (verbose) { std::cout << "Interpolator interpolator fineness: " << intp.grid_fineness << std::endl;}
