...
namespace rascal {
  ...
  BOOST_AUTO_TEST_CASE(sparsify_fps_test) {
      Eigen::Matrix<double, Eigen::Dynamic,
                    Eigen::Dynamic, Eigen::RowMajor> feature_matrix(10, 4);
      feature_matrix <<  -1.75385227, -0.23250687,  0.57691232, -1.01651329,
              0.06937612, 0.87558439,  0.40366658,  0.53847493,  0.11625195,
             -0.40740825, 0.02985093,  0.04758038,  1.13182798,  0.51740637,
              1.93431393, 1.66922457,  1.27045019, -0.43015544, -0.24192861,
              0.3747168, -0.07650897, -0.2354746 ,  0.11482844, -0.07034375,
              1.83259473, 0.04583692,  0.94401602,  1.19349946,  0.29391326,
              2.17371398, 0.42916834,  0.15842183,  0.73327368,  0.86531859,
             -0.75413054, 0.84116485,  0.18576865, -0.00515566, -1.56720151,
             -0.57342492;
      ...
      std::tie(v_ifps, v_dfps, v_ivor, v_rvor) =
