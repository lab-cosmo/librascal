...
namespace rascal {
  ...
  namespace internal {
    ...
    // template <class K, class V>
    // class InternallySortedKeyMapAlternative2 {
    //  public:
    //   using MyMap_t = std::map<K, V>;
    //   using Map_t = std::vector<int>;
    //   using Pos_t = std::vector<std::array<int, 3>>;
    ...
    //   void resize(const std::vector<key_type> & keys, const int & n_row,
    //               const int & n_col) {
    //     using Array_t = typename Map_t::mapped_type;
    //     int new_size{0};
    //     for (auto & key : keys) {
