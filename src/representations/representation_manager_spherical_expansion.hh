...
namespace rascal {
  ...
  namespace internal {
    ...
    struct AtomicSmearingSpecification<GaussianSigmaType::Constant> {
      ...
      double get_gaussian_sigma(ClusterRefKey<Order, Layer, ParentInfo_t, NeighbourLayer> & /* pair */) {
  ...
  class RepresentationManagerSphericalExpansion
   ...
   public:
    ...
    template <size_t Order, size_t Layer, typename ParentInfo_t, size_t NeighbourLayer>
    void print_soap_vector(const ClusterRefKey<Order, Layer, ParentInfo_t, NeighbourLayer> & center,
                           std::ostream & stream) {
