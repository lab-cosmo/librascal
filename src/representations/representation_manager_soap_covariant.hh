...
namespace rascal {
  ...
  namespace internal {
    enum class SOAPCovariantType { LambdaSpectrum };
  }  // namespace internal
   ...
   public:
    ...
    void set_hyperparameters(const Hypers_t & hypers) {
      ...
      if (this->soap_type_str.compare("LambdaSpectrum") == 0) {
        this->soap_type = internal::SOAPCovariantType::LambdaSpectrum;
  ...
  template <class Mngr>
  void RepresentationManagerSOAPCovariant<Mngr>::precompute_w3js() {
