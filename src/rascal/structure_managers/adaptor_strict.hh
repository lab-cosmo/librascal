  ...
  class AdaptorStrict
   ...
   public:
    ...
    Eigen::Matrix<int, Eigen::Dynamic, 5> get_gradients_info() const {
      ...
      int i_row{0};
      // we have to manually do the iteration because we do cannot
      // use this class itself as iterator, we have here AdaptorSome<...>
      // but we would need StructureManager<AdaptorSome<...>>
