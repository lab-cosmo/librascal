/**
 * @file   rascal/structure_managers/ species_manager.hh
 *
...
#ifndef SRC_RASCAL_STRUCTURE_MANAGERS_SPECIES_MANAGER_HH_
#define SRC_RASCAL_STRUCTURE_MANAGERS_SPECIES_MANAGER_HH_
...
namespace rascal {
  ...
  void SpeciesManager<ManagerImplementation, MaxOrder>::update_self() {
    ...
    // helper to go apply the filtering from the pairs to MaxOrder
...
#endif  // SRC_RASCAL_STRUCTURE_MANAGERS_SPECIES_MANAGER_HH_
