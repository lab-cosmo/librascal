/**
 * @file   rascal/structure_managers/structure_manager_centers.hh
 *
...
#define SRC_RASCAL_STRUCTURE_MANAGERS_STRUCTURE_MANAGER_CENTERS_HH_
...
namespace rascal {
  ...
  class StructureManagerCenters :
   ...
   public:
    ...
    double get_cell_volume() { return this->atoms_object.get_volume(); }
...
#endif  // SRC_RASCAL_STRUCTURE_MANAGERS_STRUCTURE_MANAGER_CENTERS_HH_
