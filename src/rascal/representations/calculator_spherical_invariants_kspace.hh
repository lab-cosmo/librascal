...
#ifndef SRC_RASCAL_REPRESENTATIONS_CALCULATOR_KSPACE_SPHERICAL_INVARIANTS_HH_
#define SRC_RASCAL_REPRESENTATIONS_CALCULATOR_KSPACE_SPHERICAL_INVARIANTS_HH_
...
namespace rascal {
  ...
  namespace internal {
    enum class SphericalInvariantsKspaceType {
      RadialSpectrum,
      PowerSpectrum,
      BiSpectrum,
    };
  ...
  class CalculatorKspaceSphericalInvariants : public CalculatorBase {
   public:
    ...
    explicit CalculatorKspaceSphericalInvariants(const Hypers_t & hypers)
    ...
    CalculatorKspaceSphericalInvariants(
        CalculatorKspaceSphericalInvariants && other) noexcept
    ...
    //! Destructor
    virtual ~CalculatorKspaceSphericalInvariants() = default;

    //! Copy assignment operator
    CalculatorKspaceSphericalInvariants &
    operator=(const CalculatorKspaceSphericalInvariants & other) = delete;

    //! Move assignment operator
    CalculatorKspaceSphericalInvariants &
    operator=(CalculatorKspaceSphericalInvariants && other) = default;
    ...
    void set_hyperparameters_powerspectrum(const Hypers_t & hypers) {
      using internal::SphericalInvariantsKspaceType;
      this->type = SphericalInvariantsKspaceType::PowerSpectrum;
    ...
    bool operator==(const CalculatorKspaceSphericalInvariants & other) const {
   ...
   protected:
    ...
    CalculatorKspaceSphericalExpansion rep_expansion;

    internal::SphericalInvariantsKspaceType type{};
...
namespace nlohmann {
  ...
  struct adl_serializer<rascal::CalculatorKspaceSphericalInvariants> {
    ...
    static void to_json(json & j,
                        const rascal::CalculatorKspaceSphericalInvariants & t) {
      j = t.hypers;
    }
  };
}  // namespace nlohmann

#endif  // SRC_RASCAL_REPRESENTATIONS_CALCULATOR_KSPACE_SPHERICAL_INVARIANTS_HH_
