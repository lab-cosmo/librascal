/**
 * @file   rascal/representations/calculator_sorted_coulomb.hh
 *
...
#ifndef SRC_RASCAL_REPRESENTATIONS_CALCULATOR_SORTED_COULOMB_HH_
#define SRC_RASCAL_REPRESENTATIONS_CALCULATOR_SORTED_COULOMB_HH_
