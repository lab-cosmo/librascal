...
namespace rascal {
  namespace internal {
    ...
    // Difference between writing data into an array and DoNotOptimize is 1%
    // (Writing is 1% faster
    template <class Fix>
    ...
    // sph_exp_intp_fix)->Apply(AllCombinationsArguments<SphericalExpansionDataset>);
    // auto sph_exp_fix =
    // SphericalExpansionBFixture<SphericalExpansionDataset>(false, false);
    // BENCHMARK_CAPTURE(BM_SphExp, no_intp_no_gradient,
    // sph_exp_fix)->Apply(AllCombinationsArguments<SphericalExpansionDataset>);
    ...
    // sph_exp_intp_gradient_fix)->Apply(AllCombinationsArguments<SphericalExpansionDataset>);
    ...
    // BENCHMARK_CAPTURE(BM_RadCon, ,
    // intp_vec_fix3)->Apply(AllCombinationsArguments<RadConDataset>)->Complexity();

    // auto intp_fix{InterpolatorScalarFixture<Hyp1f1Dataset>()};
    // BENCHMARK_CAPTURE(BM_Hyp1f1_DoNotOptimize, ,
    // intp_fix)->Apply(AllCombinationsArguments<Hyp1f1Dataset>)->Complexity();
    // BENCHMARK_CAPTURE(BM_IntpHyp1f1_DoNotOptimize, ,
    // intp_fix)->Apply(AllCombinationsArguments<Hyp1f1Dataset>)->Complexity();
